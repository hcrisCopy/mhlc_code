...
"""OpenAI-compatible proxy verifier server for Qwen3-VL + auxiliary head.
...
GENERATOR_MODEL_NAME = os.getenv("GENERATOR_MODEL_NAME", "Qwen3-VL-4B-Instruct").strip()
SERVED_MODEL_NAME = os.getenv("SERVED_MODEL_NAME", "Qwen3-VL-4B-Instruct-AuxHeadServer")

AUX_MODEL_NAME_OR_PATH = os.getenv("AUX_MODEL_NAME_OR_PATH", "Qwen/Qwen3-VL-4B-Instruct")
AUX_HEAD_CKPT = os.getenv(
    "AUX_HEAD_CKPT",
    "trained_models/"
    "Qwen3VL-4B_instruct_120K/aux_head_final.pt",
)
...
DEFAULT_AUX_HEAD_CFG = {
    ...
    "hidden_encoder_type": "strong_single",
...
class MessageAuxHeadScorer:
    def __init__(self):
        ...
        model, processor = FastVisionModel.from_pretrained(
            ...
            attn_implementation=AUX_ATTN_IMPLEMENTATION,
        )
        ...
        if image_processor is not None and hasattr(image_processor, "max_pixels"):
            image_processor.max_pixels = AUX_MAX_PIXELS
